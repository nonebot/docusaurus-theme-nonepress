...
function useDocumentsFoundPlural() {
  ...
  return (count: number) =>
    selectMessage(count, `One document found|${count} documents found`);
}
      ...
      {versionedPluginEntries.map(([pluginId, docsData]) => {
        ...
        return (
          <select
            ...
            className="w-full p-2 bg-transparent border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-light-text-active dark:focus:border-dark-text-active"
          >
        ...
        <main className="container mx-auto mt-20 pb-8 px-4 lg:px-12">
          <div className="p-4">
            <div className="prose lg:prose-xl dark:prose-dark max-w-none">
              ...
              <form
                className="grid grid-cols-1 sm:grid-cols-3 mb-2 gap-4"
                onSubmit={(e) => e.preventDefault()}
              >
                <div
                  className={clsx({
                    "col-span-2": docsSearchVersionsHelpers.versioningEnabled,
                    "col-span-3": !docsSearchVersionsHelpers.versioningEnabled,
                  })}
                >
                  <input
                    type="search"
                    name="q"
                    className="w-full p-2 outline-none border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-light-text-active dark:focus:border-dark-text-active"
              ...
              <div className="grid grid-cols-3 mb-2 gap-4">
                <div className="w-full col-span-2 font-bold text-sm">
              ...
              {searchResultState.items.length > 0 ? (
                      ...
                      >
                        ...
                        {breadcrumbs.length > 0 && (
                          <nav aria-label="breadcrumbs">
                            <ul className={clsx("pl-0 mb-0 text-sm")}>
                ...
                [
                  ...
                  !!searchResultState.loading && (
                    <div
                      key="spinner"
                      className="w-12 h-12 border-8 border-gray-300 border-t-light-text-active dark:border-t-dark-text-active animate-spin"
                    />
                  ),
                ]
              )}
              ...
              {searchResultState.hasMore && (
                <div className="mt-8" ref={setLoaderRef}>
